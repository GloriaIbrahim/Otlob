 ...
 * @author 
 */
public class AddNewMenuComponent extends javax.swing.JFrame {
    ...
    Application app;
    Admin admin;
    public AddNewMenuComponent(Application app, Admin admin,DB db) {
        initComponents();
        this.app=app;
        this.admin=admin;
        this.db=db;
    }
    public AddNewMenuComponent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Add New Menu Component");
        ...
        jLabel7.setText("Component Price");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this,"A new menu component has been added");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewMenuComponent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewMenuComponent().setVisible(true);
            }
        });
    }
