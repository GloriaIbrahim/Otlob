...
public class AddRestaurant extends javax.swing.JFrame {
    ...
    Admin admin;
    Restaurant rest;
    public AddRestaurant(Application app, Admin admin,DB db) {
        initComponents();
        this.app=app;
        this.admin=admin;
        this.db=db;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Add new Restaurant");
        ...
        jLabel5.setText("Mnimum Order Items");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this,"A new restaurant has been added");
