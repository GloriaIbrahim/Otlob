...
public class AddNewFood extends javax.swing.JFrame {
    ...
    Application app;
    Admin admin;
    ArrayList<Component> food;
    Menu menu;
    String restaurantName;
    String menuType;
    public AddNewFood(Application app, Admin admin,DB db,String restaurantName,String menuType) {
        initComponents();
        this.app=app;
        this.admin=admin;
        this.db=db;
    ...
    private void initComponents() {
        ...
        jButton5.setText("Add New Component");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            app.editRestaurantMenu(restaurantName, menu);
            Transactions pr = new Transactions (app,admin,db);
            pr.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
